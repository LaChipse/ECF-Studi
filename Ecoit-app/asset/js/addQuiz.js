...
/* Ajoute des réponse au quiz et controle leur nombre */
$(".addRep").click(function() {
    if (count <= 2) {
        ...
        $(".sectionInput").append('<p class="errorMessage" style="color: red; font-size: 18px; margin-top: 15px">Maximum de mauvaises reponses atteint </p>');

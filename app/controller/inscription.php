    ...
    if (strval($_GET['role']) === "instructeur") {
        ...
        if(isset($_FILES["photoprofil"]) && $_FILES["photoprofil"]["error"] == 0){
            ...
            if(in_array($filetype, $allowed)){
                ...
                if(file_exists("../asset/dl/img/profil/" . $_FILES["photoprofil"]["name"])){
                    echo $_FILES["photoprofil"]["name"] . " existe déjà.";
                } else {
                    move_uploaded_file($_FILES["photoprofil"]["tmp_name"], "../asset/dl/img/profil/" . $_FILES["photoprofil"]["name"]);
        ...
        $dataModel->photoprofil = "../asset/dl/img/profil" . $_FILES["photoprofil"]["name"];
